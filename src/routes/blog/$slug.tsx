...
function BlogPost() {
		...
		return (
			<div className="flex items-center justify-center min-h-[50vh] px-4">
				<PixelCard className="text-center p-6 md:p-8 3xl:p-12 4xl:p-16">
					<h1 className="text-2xl md:text-4xl 3xl:text-5xl 4xl:text-6xl font-pixel mb-2 md:mb-4">404</h1>
	...
	return (
		<article className="max-w-3xl mx-auto space-y-6 md:space-y-8 3xl:space-y-10 4xl:space-y-12 pb-12 md:pb-16 3xl:pb-20 4xl:pb-32 px-4 md:px-6 lg:px-8 py-8 md:py-12 3xl:py-16 4xl:py-24">
			{post.coverImage && (
				<motion.div
